...
namespace CozaStore_AspNetCore6.Infrastructure.TagHelpers
{
    ...
    public class UserRoleTagHelper : TagHelper
    {
        ...
        public UserRoleTagHelper(UserManager<CustomUser> userManager, RoleManager<IdentityRole> roleManager)
        {
